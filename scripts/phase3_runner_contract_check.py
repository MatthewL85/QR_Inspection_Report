...
REQUIRED_CHECK_LABELS = {
    ...
    "Notification Role Visibility Contract",
    "Navbar Notification Contract",
    "Role Dashboard Surface Contract",
    "Role Dashboard Login/Render Smoke",
    "Operational Surface Render Smoke",
    "Key Site Information Contract",
    "Role Dashboard Notification Contract",
    "Works Command Centre Contract",
    "Queue Surface Contract",
    "Contractor Standalone Docket Contract",
    "Media Evidence Spine",
    "Works Evidence Audit Contract",
    "Contractor Evidence Propagation Contract",
    "Role Dashboard Attention Contract",
    "Template References",
    "URL References",
    "GAR Context",
    "GAR Role Visibility Contract",
    "GAR Source Adapter Contract",
    "GAR Inquiry Endpoints",
