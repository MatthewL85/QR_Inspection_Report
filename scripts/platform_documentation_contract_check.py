...
REQUIRED_REFERENCES = {
    ...
    "docs/stabilisation_security_closeout.md": (
        ...
        "schema and migration ownership boundaries must keep database changes module-owned",
    ...
    "docs/deployment_environment_security_matrix.md": (
        ...
        "Schema changes must follow the schema and migration ownership contract",
        "Finance Logix",
        "Contractor Logix",
        "GAR AI Layer",
    ...
    "docs/release_change_management_matrix.md": (
        ...
        "Schema and migration changes must follow the schema and migration ownership contract",
