...
class Document(db.Model):
    ...
    unit = db.relationship("Unit", back_populates="documents")
    ...
    def __repr__(self):
        return f"<Document {self.file_name} unit={self.unit_id} client={self.linked_client_id}>"
